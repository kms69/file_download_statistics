 ...
 * @group statistics
 */
class FileDownloadStatisticsLoggingTest extends BrowserTestBase {
   ...
   * @var array
   */
  public static $modules = ['node', 'file_download_statistics', 'block', 'locale'];
  ...
  protected function setUp() {
    ...
    // Clear the logs.
    db_truncate('file_download_statistics');
