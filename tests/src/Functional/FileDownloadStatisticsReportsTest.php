 ...
 *
 * @group file_download_statistics
 */
class FileDownloadStatisticsReportsTest extends FileDownloadStatisticsTestBase {
  ...
  public function testPopularContentBlock() {
    ...
    $block = $this->drupalPlaceBlock('file_download_statistics_popular_block', [
